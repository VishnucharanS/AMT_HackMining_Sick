...
class LidarNode(Node):
    ...
    def extract_features(self,points):
        ...
        # Density
        density = num_points / (mean_range + 1e-6)

        # Near field ratio (dust appears close)
        near_points = points[points[:,4] < 5.0]
        near_ratio = len(near_points) / (num_points + 1e-6)
