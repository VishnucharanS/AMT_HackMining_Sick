...
def main():
    ...
    dataset = MultiModalDataset("dataset", transform=train_transform)

    train_size = int(0.7 * len(dataset))
    val_size = len(dataset) - train_size

    train_dataset = MultiModalDataset("dataset", transform=train_transform, add_noise=True)
    val_dataset   = MultiModalDataset("dataset", transform=train_transform, add_noise=False)

    train_ds, _ = random_split(train_dataset, [train_size, val_size])
